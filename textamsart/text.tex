...
\subsection{Non so se questa cosa serve a qualcosa}
...
\[
\text{Var}_\mathcal{R}(u,[a,b])=\sup\left\{\sum_{k=1}^N\mathcal{R}(u(t_k))-\mathcal{R}(u(t_{k-1}))\;\middle|\;\substack{N\in\mathbb{N}\\[0.5em]a=t_0<\dots<t_N=b}\right\}.
\]
...
\subsection{A chain-rule formula for the energy}
...
\begin{equation}
\partial_u\mathcal{E}(u(t),t)+\partial\Phi_\eta(\dot u(t))\ni0.
\end{equation}
\begin{prop}
...
\mathcal{E}(u(t),t)+\int_s^t\left(\Phi_\eta(\dot u(r))+\Phi_\eta^*(-\partial_u\mathcal{E}(u(r),r)\right)dr=\mathcal{E}(u(s),s)+\int_s^t\partial_t\mathcal{E}(u(t),t)dr
\end{equation}
...
Let
\[
\xi_\eta(t)=-\partial_u\mathcal{E}(u_\eta(t),t)\quad\text{and}\quad p_\eta(t)=-\partial_t\mathcal{E}(u_\eta(t),t).
\]
...
This concludes the proof.
\end{proof}
Let $\mathbf{s}_\eta\colon[0,T]\to[0,\mathbf{S}_\eta]$ defined by
\[
\mathbf{s}_\eta(t)=t+\int_0^t\mathfrak{p}(\dot u_\eta(s),-\partial_t\mathcal{E}(u_\eta(s),s))ds\quad\text{and}\quad\mathbf{S}_\eta=\mathbf{s}_\eta(T).
\]
Let also
\[
\mathbf{t}_\eta=\mathbf{s}_\eta^{-1}\colon[0,\mathbf{S}_\eta]\to[0,T]\quad\text{and}\quad\mathbf{u}_\eta=u_\eta(\mathbf{t}_\eta)\colon[0,\mathbf{S}_\eta]\to V.
\]
