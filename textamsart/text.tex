...
\emph{Step 2}. Now since $\mathcal{R}$ is continuous and $D_E$ is compact, then $\mathcal{R}$ is uniformly continuous on $D_E$. Let $\omega$ the corresponding continuity modulus. RIPARTIRE DA QUI.
\end{proof}
