...
\color{red}
THIS SECTION HAS YET TO BE COMPLETED. IT'S NOT EVEN NECESSARY FOR IT TO BE KEPT IN ACTUALITY, SINCE I DON'T THINK I WILL HAVE TIME TO APPLY IT IN THE REST OF THE THESIS (I HAD IN MIND OF USING A GENERALIZED VERSION OF THE NOTION OF BALANCED-VISCOSITY SOLUTIONS TO STUDY THE EVENSCENT VISCOSITY LIMIT OF THE PROBLEM BOUND TREATED IN THE SECTION~\ref{sec:existence-theorem-abstract-constrained}.) SO, IF I WILL KEEP THIS SECTION SO IT WILL ONLY BE FOR THE PURPOSE OF ILLUSTRATING A POSSIBLE MORE LOCAL ALTERNATIVE TO ENERGY SOLUTIONS.
\color{black}
