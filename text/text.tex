...
\tag{W1}
\\
\parbox{0.8\textwidth}{$W(E_1,E_2,G)=\infty$ if $E_1\le0$ or $E_2\le0$}
\tag{W2}
\end{gather}
...
\tag{H1}
\\
\parbox{0.8\textwidth}{there exists $p>0$ such that $H(P,P')=\infty$ if $P\le p$}
\tag{H2}
\end{gather}
...
g_1'(y_1^k,t)(y_1^k)'g_2(y_1^k,t)^ky_2^k&\rightharpoonup g_1'(y_1,t)y_1'g_2(y_1,t)y_2\quad&\text{in $L^1((0,L))$}.
\end{align*}
