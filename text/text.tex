...
NOW I WILL FOCUS ON A PARTICULAR CONSTITUTIVE RELATION. I WILL FOCUS ON
\[
W(E_1,E_2,G)=C(E_1^2+E_2^2-2\log(E_1E_2)-2)+\frac{1}{2}l^2C G^2
\]
...
\parbox[c]{0.8\textwidth}{for all $q\in\mathscr{D}$ the function $\mathcal{E}(q,\cdot)$ is $C^1([0,T])$, uniformly continuous on $\mathscr{D}\times[0,T]$, and there exist $C_1^E$ and $C_0^E$ such that $|\partial_t\mathcal{E}(q,t)|\le C_1^E(C_0^E+\mathcal{E}(q,t))$ for all $t\in[0,T]$.}
\tag{E3}
\end{gather}
