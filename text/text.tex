...
\end{axis}
\end{tikzpicture}
\caption{Graphs of $F^*$ and $\lambda$ as functions of the elongation $a$ along the homogeneous solution in the plastic model. The solid line is referred to the model $H$ in (ii) and the dashed line to $H$ in (i).}
...
\[
\tilde{\mathcal{W}}\doteq\dual{\mathcal{W},\tilde w}=\dual{\mathcal{P},\tilde w}\doteq\tilde{\mathcal{P}}\quad\text{for all $\tilde w\in\boldsymbol{Z}$}
\]
