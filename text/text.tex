...
Let $Y=W^{1,q}((0,L),\mathbb{R}^2)$ with $q\in(??,\infty)$ and $Z=L^{q_H}\cap W^{1,r}((0,L))$. Set $Q=Y\times Z$.
...
Energy
\begin{multline*}
\mathcal{E}(y,P,t)=\int_0^L W\left(\dind{g_1}{y_1}(y_1,t)y_1'P^{-1},g_2(y_1,y_2,t)P,\dind{g_2}{y_1}(y_1,y_2,t)y_2'P^{-1}\right)dX+\int_0^LH(P,P')dX-\\
-\int_0^L\left(f_1g_1(y_1,t)+f_2g_2(y_2,t)\right)dX.
\end{multline*}
...
\end{prop}
\begin{proof}
First notice that for $i\in\{1,2\}$
\[
%a|y_iP^{-1}|=|\dind{g_i}{y_1}(y_i,t)|^{-1}|\dind{g_i}{y_1}(y_i,t)y_i'P^{-1}|\le C|\dind{g_i}{y_1}(y_i,t)y_i'P^{-1}|.
\]
Moreover by H\"older inequality
\[
\norm{\}_{q}
\]
...
\[
\begin{split}
\mathcal{E}(y,P,t)&\ge C(1+\norm{g_1'(y_1,t)y_1'P^{-1}}_{q_W}^{q_W}+\norm{y_2'P}_{q_W}^{q_W}+\norm{g_2'(y_2,t)y_2'P^{-1}}_{q_W}^{q_W}+\norm{P}_{q_H}^{q_H}+\norm{P'}_r^r)\\
&\ge C(1+\norm{y_1'P^{-1}}_{q_W}^{q_W}+\norm{y_2'P}_{q_W}^{q_W}+\norm{y_2'P^{-1}}_{q_W}^{q_W}+\norm{P}_{q_H}^{q_H}+\norm{P'}_r^r)
\end{split}
\]
\end{proof}
