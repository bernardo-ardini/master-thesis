...
\section{A review of gradient plasticity theory}
\label{sec:plasticity-review}

Plasticity theory concerns with the description of the mechanical behavior of solids beyond the elastic limit, when not recoverable deformations accumulates.

In this section we give a concise description of plasticity theory, both at regime of small and large deformations, inserting it in the general framework proposed in Section~\ref{sec:ppv}.
...
(z^1,z^2)&\mapsto z_1\bullet z_2=(\chi^1\circ\chi^2,(F_p^1\circ \chi^2)F_p^2).
\end{split}
\]
